...
Options testing_options(int kpt = 3, bool rsm = true, int batchsize = 2, string output_directory = "kpt3", bool debug = true) {
    Options opts;
    opts.gpu_id = 0;
    opts.dname = "lm";
...
{
    Options opts = testing_options(1, true, 2, "kpt1", true);
    RCVpose rcv(opts);
    rcv.train();
}
